...
// (test/unit/audit-lib.test.ts). audit-drift.mjs stays the script shell.
// Ported from demo-math; this repo adds the `typecheck-fail` check
// (ADR-0002) and renames the auto-fix class to biome (ADR-0003).
// =====================================================================
...
// Working Agreement #10: every PR body must carry a "## Deviations from
...
// Memory hygiene (Working Agreement #11): an append-only lessons log decays
// into a junk drawer — the failure mode is retrieval, not capture. Past
// ~500 lines, LEARNINGS.md is due for a distillation pass (promote
