...
1. Look at `docs/adr/` to find the next number (zero-padded, e.g. `0009`).
2. Copy `docs/adr/0000-template.md` to `docs/adr/<NNNN>-<kebab-title>.md`.
3. Fill in the title, set **Status: Proposed** and today's date, and draft
   the Context / Decision / Consequences / Alternatives from what we just
   discussed.
